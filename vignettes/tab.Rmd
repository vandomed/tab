...
include_graphics("C:/Users/vando/Google Drive/github/tab/vignettes/logistic.png")
```
...
```{r out.width = "100%", echo = FALSE}
include_graphics("C:/Users/vando/Google Drive/github/tab/vignettes/tabmulti.png")
```
