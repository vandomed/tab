...
fit <- glm(bp.1 ~ poly(Age, 2, raw = TRUE) + BMI * BMI + Sex + Sex*Race, data = tabdata)
columns = NULL
xlabels = NULL
...
tabglm <- function(fit,
  ...
  # Need to figure out clean way to handle interaction terms and polynomials.
